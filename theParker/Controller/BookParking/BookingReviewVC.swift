...
extension BookingReviewVC {
    func setUpData() {
        ...
        let transaction = Transaction.init(amount: marker.price_hourly, for_parking_id: marker.pinKey, from: (Auth.auth().currentUser?.uid)!, to: marker.by, transId: nil, timestamp: nil)
